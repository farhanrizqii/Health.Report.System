                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('imunisasi.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="tanggal_imunisasi" id="tanggal_imunisasi" value="{{ old('tanggal_imunisasi') }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100">
