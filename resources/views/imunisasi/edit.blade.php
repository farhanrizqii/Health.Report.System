            ...
            <div class="form-card">
                ...
                <form action="{{ route('imunisasi.update', $imunisasi) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" name="penduduk_id" value="{{ $imunisasi->penduduk_id }}">
                        <input type="text" value="{{ $imunisasi->penduduk->nama_lengkap }} (NIK: {{ $imunisasi->penduduk->nik }})" disabled class="form-input">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="tanggal_imunisasi" id="tanggal_imunisasi" value="{{ old('tanggal_imunisasi', $imunisasi->tanggal_imunisasi) }}" required class="form-input">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="faskes" id="faskes" rows="3" class="form-textarea">{{ old('faskes', $imunisasi->faskes) }}</textarea>
                        @error('faskes')
                            <p class="error-message">{{ $message }}</p>
                        @enderror
                    </div>
