            ...
            <div class="form-card">
                ...
                <form action="{{ route('penduduk.store') }}" method="POST">
                        ...
                        <select name="wilayah_id" id="wilayah_id" required class="form-select">
                            ...
                            @foreach($wilayahs as $wilayah)
                                <option value="{{ $wilayah->id }}" {{ old('wilayah_id') == $wilayah->id ? 'selected' : '' }}>
                                    {{ $wilayah->kelurahan }} (RW: {{ $wilayah->rw ?? '-' }})
                                </option>
                            @endforeach
                        </select>
                        @error('wilayah_id')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nik" id="nik" value="{{ old('nik') }}" required maxlength="16" class="form-input">
                        @error('nik')
                            <p class="error-message">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_lengkap" id="nama_lengkap" value="{{ old('nama_lengkap') }}" required class="form-input">
                        @error('nama_lengkap')
                            <p class="error-message">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="tanggal_lahir" id="tanggal_lahir" value="{{ old('tanggal_lahir') }}" required class="form-input">
                        @error('tanggal_lahir')
                            <p class="error-message">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="radio-group">
                            ...
                            <label class="radio-label">
                                <input type="radio" name="jenis_kelamin" value="P" {{ old('jenis_kelamin') == 'P' ? 'checked' : '' }} required class="radio-input">
                    ...
                    <div class="form-group">
                        ...
                        <select name="golongan_darah" id="golongan_darah" class="form-select">
                            ...
                            @foreach(['A', 'B', 'AB', 'O', 'Tidak Tahu'] as $darah)
                                <option value="{{ $darah }}" {{ old('golongan_darah') == $darah ? 'selected' : '' }}>{{ $darah }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="alamat" id="alamat" rows="3" required class="form-textarea">{{ old('alamat') }}</textarea>
                        @error('alamat')
                            <p class="error-message">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="no_kk" id="no_kk" value="{{ old('no_kk') }}" class="form-input">
                        @error('no_kk')
                            <p class="error-message">{{ $message }}</p>
                        @enderror
                    </div>
