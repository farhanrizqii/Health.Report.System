            ...
            <div class="data-card">
                <div class="text-gray-900 dark:text-gray-100">
                    ...
                    <div class="action-buttons-container"> 
                        <a href="{{ route('fasilitas-kesehatan.create') }}" class="btn-tambah">
                            <i class="fas fa-plus"></i>
                            <span>Tambah Fasilitas Baru</span>
                        </a>
                        <a href="{{ route('fasilitas-kesehatan.export') }}" class="btn-ekspor">
                    ...
                    <!-- Search Form -->
                    <form method="GET" action="{{ route('fasilitas-kesehatan.index') }}" class="flex items-center w-full md:w-1/3 mb-8">
                        <input type="text" name="search" placeholder="Cari Nama, Jenis, atau Alamat..." 
                        ...
                        @if (request('search'))
                            <a href="{{ route('fasilitas-kesehatan.index') }}" class="text-sm text-red-500 hover:text-red-700 dark:text-red-400 dark:hover:text-red-600 font-semibold ml-3">Reset</a>
                        @endif
                    </form>
                    ...
                    <div class="overflow-x-auto">
                            ...
                            <table class="data-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-left">Jenis Faskes</th>
                                ...
                                <tbody>
                                    @foreach ($fasilitas as $index => $f)
                                        <tr>
                                            <td class="whitespace-nowrap text-center">{{ $index + $fasilitas->firstItem() }}</td>
                                            ...
                                            <td class="whitespace-nowrap text-center space-x-2">
                                                <a href="{{ route('fasilitas-kesehatan.show', $f) }}" class="action-link link-detail">
                                                    <i class="fas fa-eye"></i>Detail
                                                </a>

                                                <a href="{{ route('fasilitas-kesehatan.edit', $f) }}" class="action-link link-edit">
                                                    <i class="fas fa-edit"></i>Edit
                                                </a>

                                                <form action="{{ route('fasilitas-kesehatan.destroy', $f) }}" method="POST" class="inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus fasilitas {{ $f->nama_faskes }}? Aksi ini tidak dapat dibatalkan.');">
                                                    @csrf
                                                    @method('DELETE')
                        ...
                        @else
                            <p class="text-center text-gray-500 dark:text-gray-400 py-8">Belum ada data fasilitas kesehatan yang tercatat.</p>
                        @endif
